...
<h1 align="center">youtube-agent</h1>

<p align="center">
  <strong>An AI-powered agent that searches, analyzes, and extracts structured insights from YouTube videos. It can find relevant videos, summarize content, extract key points or timestamps, identify speakers or topics, and transform unstructured video information into clean, usable data for research, learning, or content analysis.</strong>
</p>

<p align="center">
  <a href="https://github.com/Paraschamoli/youtube-agent/actions/workflows/main.yml?query=branch%3Amain">
    <img src="https://img.shields.io/github/actions/workflow/status/Paraschamoli/youtube-agent/main.yml?branch=main" alt="Build status">
  </a>
...
An AI-powered agent that searches, analyzes, and extracts structured insights from YouTube videos. It can find relevant videos, summarize content, extract key points or timestamps, identify speakers or topics, and transform unstructured video information into clean, usable data for research, learning, or content analysis.. Built on the [Bindu Agent Framework](https://github.com/getbindu/bindu) for the Internet of Agents.
...
gh repo create Paraschamoli/youtube-agent} --public --source=. --remote=origin --push
```
...
- 📖 [Full Documentation](https://Paraschamoli.github.io/youtube-agent/)
- 💻 [GitHub Repository](https://github.com/Paraschamoli/youtube-agent/)
- 🐛 [Report Issues](https://github.com/Paraschamoli/youtube-agent/issues)
...
<p align="center">
  <a href="https://github.com/Paraschamoli/youtube-agent">⭐ Star this repo</a> •
  <a href="https://discord.gg/3w5zuYUuwt">💬 Join Discord</a> •
  <a href="https://bindus.directory">🌐 Agent Directory</a>
</p>

#   y o u t u b e - a g e n t  
 